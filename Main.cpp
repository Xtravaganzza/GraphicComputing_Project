...
int main()
{
	...
	Model Living((char*)"Models/LivingRoom/livingRoom.obj");
	Model Living2((char*)"Models/LivingRoom/livingRoom2.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		**************************************************************************************************************************/
		...
		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		Living.Draw(lightingShader);
		
		model = glm::mat4(1);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		Living2.Draw(lightingShader);
		...
		model = glm::rotate(model, glm::radians(rotSled), glm::vec3(0.0f, 1.0f, 0.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
